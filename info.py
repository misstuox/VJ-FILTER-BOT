...
# Bot information
SESSION = environ.get('SESSION', 'Mixy_ox_bot')
API_ID = int(environ.get('API_ID', '23129834'))
API_HASH = environ.get('API_HASH', '1ae4259098c4c4d3663862a5aa1831d2')
BOT_TOKEN = environ.get('BOT_TOKEN', "7517204717:AAEBxm-Mhkw73UkFnsOAgMtbfxyidWcbfbE")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '2515814548'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '2350247518').split()]  # For Multiple Id Use One Space Between Each.
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '6052975324')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://misstuox:Xzi1zyhlfLRLe7Af@cluster0.jzr0l.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "misstuox")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'misstu')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Mixy_movie_request_group')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+5JR2X8eexik4YWI9')
